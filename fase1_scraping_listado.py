...
def scrapear_todas_las_paginas(max_paginas: int = 25):
    """
    Recorre las páginas de resultados hasta max_paginas, o hasta que una
    página no tenga tarjetas (señal de que ya no hay más resultados).
    """
    todos_los_avisos = []
    ...
    for numero_pagina in range(1, max_paginas + 1):
        ...
        for tarjeta in tarjetas:
            datos_aviso = parsear_tarjeta(tarjeta)
...
if __name__ == "__main__":
    avisos = scrapear_todas_las_paginas(max_paginas=25)
